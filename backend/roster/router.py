...
# Import dependencies from dependencies module (not main.py — avoid circular imports)
from backend.dependencies import get_db, get_admin_user, get_current_active_user, get_current_user_optional
